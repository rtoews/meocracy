...
<ul data-role='listview' data-inset='false' data-theme='a'  data-divider-theme='a'>
    <li>
        <a href="/issues.php?type=<?php echo REGION_CITY; ?>"><?php echo $city->image_tag(); ?><?php echo $city->city_name(); ?></a>
    </li>
    <li>
        <a href="/issues.php?type=<?php echo REGION_COUNTY; ?>"><?php echo $city->county->image_tag(); ?><?php echo $city->county->county_name(); ?></a>
    </li>
    <li>
        <a href="/issues.php?type=<?php echo REGION_STATE; ?>"><?php echo $city->state->image_tag(); ?><?php echo $city->state->state_name(); ?></a>
    </li>
</ul>
<?php
