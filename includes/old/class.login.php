...
var $hostname_logon = 'meocracy2.db.3410806.hostedresource.com'; //Database server LOCATION
var $database_logon = 'meocracy2'; //Database NAME
var $username_logon = 'meocracy2'; //Database USERNAME
var $password_logon = 'Badlsd22'; //Database PASSWORD
//table fields
var $user_table = 'tsmUser'; //Users table name
var $user_column = 'EmailAddress'; //USERNAME column (value MUST be valid email)
var $pass_column = 'EncryptedPass'; //PASSWORD column
